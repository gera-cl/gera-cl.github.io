...
export default function About() {
    ...
    return (
        <section id="about" className="pt-20 w-full">
            <div className="w-full sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 
                    bg-slate-100 dark:bg-slate-800 mx-auto lg:rounded-2xl py-14 px-4 sm:px-5 md:px-10 lg:px-20">
                <span className="text-4xl font-semibold dark:text-white after:h-[.125rem] after:bg-slate-900 dark:after:bg-slate-200 after:inline-block 
                        after:relative after:align-middle after:w-48 after:left-4 after:bg-gradient-to-l after:from-sky-400 after:to-sky-600">
                    About Me
                </span>
                <div className="grid grid-cols-12 md:gap-10 pt-4 md:pt-[40px] items-center">
                    <div className="col-span-12 md:col-span-4"><Image alt="routePath" src="/_next/image?url=%2Fimages%2Fabout%2Fabout.jpg&amp;w=640&amp;q=75" width="300" height="400" decoding="async" data-nimg="1" className="w-full md:w-[330px] md:h-[400px] object-cover overflow-hidden rounded-[35px] mb-3 md:mb-0" loading="lazy"/></div>
                    <div className="col-span-12 md:col-span-8 space-y-2.5">
                        <div className=" md:mr-12 xl:mr-16">
                            <h3 className="text-4xl font-medium dark:text-white mb-2.5 ">Who am i?</h3>
                            <p className="text-gray-lite dark:text-color-910 leading-7 text-justify">{t('profile-info')}</p>
                        </div>
                        {/* <div>
                            ...
                            <div className=" grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div className="flex">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <h6 className="font-medium dark:text-white"><a className="hover:text-[#FA5252] duration-300 transition" href="tel:+1234567890">+123 456 7890</a></h6>
                                    </div>
                                </div>
                                <div className="flex">
                                ...
                                <div className="flex">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <h6 className="font-medium dark:text-white"> <a className="hover:text-[#FA5252] duration-300 transition" href="mailto:ibthemes21@gmail.com">example@mail.com</a></h6>
                                    </div>
                                </div>
                                <div className="flex">
